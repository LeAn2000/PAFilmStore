...
import com.pastore.pafilmstore.ViewModels.UpComeListViewModel;
 ...
 */
public class UpcomingFragment extends Fragment implements OnListener {

    private RecyclerView recyclerView;
    private FilmRecycler filmRecycler;
    private UpComeListViewModel model;
    View mview;
    int page = 1;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        model = new ViewModelProvider(this).get(UpComeListViewModel.class);
        mview= inflater.inflate(R.layout.fragment_upcoming, container, false);
        recyclerView = mview.findViewById(R.id.recyclerView_up);
        return mview;
